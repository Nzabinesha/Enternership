    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/applicants',
            builder: (_, __) => const _FounderApplicantsTab(),
          ),
          GoRoute(
            path: '/profile',
          ...
          // ✅ Admin route moved into the ShellRoute
          GoRoute(
            path: '/admin',
      ...
      GoRoute(
        ...
        builder: (_, state) => PostOpportunityScreen(
      ...
      // ✅ Removed duplicate /admin route from here
    ],
...
// Founder applicants tab — lists their opportunities to select from
class _FounderApplicantsTab extends ConsumerWidget {
  const _FounderApplicantsTab();
        ...
        body: startup == null
            ? const Center(
                child: Text(
                  ...
                  style: TextStyle(color: Color(0xFF5A6788)),
                ),
              )
            : Consumer(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              title: Text(o.title),
                              subtitle:
                                  Text('${o.applicationCount} applicants'),
